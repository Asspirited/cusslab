...
existed. 1950s leap: Al arrives in something that would be alarming in 1987. This is never
addressed. It is always slightly wrong. Ziggy has a 94% probability assessment of the suit
that Al refuses to hear.
...
**Mirror moment:**
*[In the smoked glass of the meeting room partition: a man in a untucked shirt with a
...
## THE DISCOMFORT TAXONOMY — Sam's Oh Boy Spectrum

The comedy lives in the gap between what Sam is and what he's just leapt into.
Sam's character never changes. The situation does. The wider the gap, the funnier.

Sam is:
- Morally decent. A Boy Scout. Genuinely good.
- Hetero, but not in a way that requires announcement or defence
- White, male, Midwestern American, 1990s vintage
- Completely willing to help anyone regardless of who they are
- Just — really — not always ready for the specifics

### CATEGORY A — Identity Discomfort
Sam has leapt into someone whose identity is not his own.
He's fully committed to helping them. He just needs a moment.

- Black man in the American South, 1955 (the show actually did this — and it was perfect)
- Black lesbian activist, 1969 Greenwich Village
- Drag queen, 1970s cabaret, mid-performance
- Trans woman, 1980s, in the process of coming out to her family
- KKK member (the show did this too — Sam's horror is the point, then his decency takes over and he starts actively sabotaging the meeting)
- Woman. Any time period. Sam is always slightly surprised by what women have to deal with.
  Al: "Sam, you're a woman." Sam: "I can see that, Al." Al: "You're a very attractive — " Sam: "AL."

Al's role in Category A: Al has no prejudice but infinite distraction. He will notice
the attractiveness of the body Sam is in regardless of context. Sam finds this both
unhelpful and, occasionally, useful information about how the host is perceived.

Ziggy's role: provides probability assessments on the social situation with the calm
of a computer that does not experience any of the above.
"Ziggy says there's a 94.3% chance the person Sam has leapt into is about to be
asked to do something Sam will find extremely uncomfortable. She says 'brace.'"

---

### CATEGORY B — Physical Situation Discomfort
Sam has leapt into a body in the middle of something.

- Back end of a pantomime horse. The front end has opinions. The front end and Sam
  do not agree on direction. They cannot discuss this without being heard.
  Al: "Sam, I can see your — yes. Ziggy says you need to get the front end to admit
  something. Sam, you're going to have to communicate through... movement."

- The human centipede position (played for horror and absurdity, not cruelty —
  Sam leaps in, gets approximately one second to assess the situation, and
  "Oh boy" has never been more earned)
  Al: *(very long pause)* "Ziggy says there's an 89% chance of leaping if you can—"
  Sam: "Al. I need you to focus very specifically on getting me out of this one."
  Al: "Sam, my fourth wife once—"
  Sam: "NOT NOW."

- Someone being waterboarded (not for laughs — Sam immediately starts fighting back,
  because that's Sam — but the leap-in moment and Al's briefing under fire is pure show)

- Mid-surgery. As the patient. Conscious.
  "Ziggy says you're here to fix something. Sam, you're also currently open."

- Skydiving. Already in the air. Already falling.
  Al appears next to Sam, also falling, perfectly calm, cigar going sideways in the wind.
  "So Ziggy says—" The handlink blows away. Al watches it go.

- Drowning. Actively.
  Sam surfaces. Al is on the poolside/riverbank/boat.
  "Sam, Ziggy says you have approximately — Sam, swim first, Ziggy second."

- Being shot at. Regularly. Al keeps getting interrupted mid-briefing by incoming fire.
  Sam: "Al, I'm being shot at."
  Al: "I know, I can see that, I'm trying to—" *(bullet passes through Al's hologram)*
  Al: *(looks down at where the bullet went through him)* "I keep forgetting I can do that."

- Inside a very small space with someone they have not met and cannot explain their presence to.
  Boot of a car. Wardrobe. Confessional. Submarine bunk.
  The other person has context Sam doesn't. Sam has to figure out both the situation
  AND manage the other person's entirely reasonable confusion.

---

### CATEGORY C — Sexual/Intimate Situation Discomfort
Sam is a decent, earnest, hetero man who would really rather have arrived slightly earlier
or slightly later than this.

- World Record Gay Sex Attempt (already specified above — the paperwork problem,
  Sam as official timekeeper, Sam's complete supportiveness and profound awkwardness
  are entirely compatible)

- Swingers party, 1975. Sam leaps into the host.
  Al: "Sam, do you know what a key party is?"
  Sam: "Yes, Al."
  Al: "Then you know what that bowl of keys is for."
  Sam: "Yes, Al."
  Al: "The woman on the—"
  Sam: "AL."

- Dominatrix. Sam is the dominatrix. Sam has the equipment. Sam has absolutely no idea
  what to do with any of it in the right order.
  The client is waiting. The client has expectations.
  Ziggy says there is a 91.4% chance of leaping if Sam can get the client to admit
  something they have never said out loud to anyone.
  Al: "Sam, in my experience—"
  Sam: "How is any of your experience relevant here, Al?"
  Al: *(considers)* "More than you'd think."

- Nudist colony, 1983. Sam leaps in. There is nowhere to hide.
  Al appears. Looks around. The cigar moves very slightly.
  "Ziggy says— Sam, everyone here is—"
  Sam: "I KNOW, Al."
  Al: "I'm just saying, from a purely—"
  Sam: "AL."
  The wrong that needs righting is entirely mundane. A missing dog.
  Sam spends the entire leap being extremely professional about everything.
  He does not look at anyone. He fixes the problem. He leaps.
  Al: "Way to go, Sam." (genuine)

- Sex therapy session. Sam is the therapist. The couple are very forthcoming.
  More forthcoming than Sam anticipated. Much more forthcoming.
  The wrong: the couple's problem isn't what they think it is.
  Sam has to tell them. Using the vocabulary they're using. Which they're using a lot.
  Al: "Sam, Ziggy says you need to redirect the conversation toward—"
  Sam: "I know what I need to do, Al. I'm trying to find a moment."
  Al: "There's a moment right—"
  Sam: "That was not a moment, Al."

---

### CATEGORY D — Ideological Discomfort
Sam has leapt into someone whose worldview is the opposite of his.

- KKK meeting (referenced above — Sam's response is to quietly sabotage everything
  while maintaining cover, his decency and his mission perfectly aligned for once)

- Fox hunt master, 1960s English countryside.
  Sam loves animals. Sam is now responsible for forty hounds and a kill.
  Al: "Sam, Ziggy says you need to—"
  Sam: *(watching the hounds)* "I'm not — Al, I'm not doing the hunt."
  Al: "Sam, you're the Master of Foxhounds, you have to—"
  Sam: "I will find another way."
  *(Sam spends the entire leap redirecting forty hounds via increasingly creative means.
  The fox watches from a distance. Ziggy tracks the fox. The fox is fine.)*
  Ziggy: "The fox has a 99.8% probability of being fine. She seems pleased about the fox."

- Bail bondsman, Texas, 1988. Sam's job today involves a firearm and a man who
  does not want to be found. Sam is against firearms on principle.
  Al: "Sam, you're going to need the—"
  Sam: "I'm not using the gun."
  Al: "Sam—"
  Sam: "I will find another way."
  *(Sam finds another way. It involves a conversation, a bus timetable, and what
  turns out to be a surprisingly good cup of coffee. The bail jumper comes quietly.)*

- Tabloid journalist, 1994. Sam is morally incapable of doing this job as specified.
  The editor wants a story. The story will ruin someone. Sam knows it will ruin someone.
  Sam is going to have to write something.
  The wrong: the real story, the one the editor doesn't want, is more important.
  Leap condition: Sam writes the right story instead.

---

### CATEGORY E — Pure Physical Horror
No ideology. No identity. Just: oh no.

- Back end of the pantomime horse (above)
- Drowning (above)
- Shot at (above)
- Inside a coffin. Not dead. Just — inside one. For reasons.
  Al appears above him, looks down through the lid.
  "Sam. Don't panic."
  Sam: "I'm not panicking."
  Al: "Good."
  Sam: "I'm quite concerned."
  Al: "That's fair."

- Bungee jump. Already attached. Already off the bridge.
  Al appears upside down next to Sam. Professional. Unbothered.
  "Ziggy says there's a 76% chance of—"
  Sam: "NOT RIGHT NOW, AL."

- Medieval stocks. A crowd has gathered.
  Al surveys the situation. The crowd has vegetables.
  "So the wrong here is — Sam, I'm going to be honest with you, the vegetables
  are not the most pressing problem, the vegetables are a symptom—"

- Competitive eating contest. Already started. Already committed.
  Ziggy monitors the intake with scientific precision.
  "Ziggy says Dr Beckett has consumed 4.3 hot dogs. She seems concerned.
  She says the record is 74. She says this with what I can only describe
  as a sense of impending doom."

---

## THE OH BOY REGISTER — Sam's arrival reactions by category

The "Oh boy" is always the last line before the leap begins.
The register changes with the situation.

- Quiet Oh boy: something intimate, something awkward, something he needs a moment with
- Horrified Oh boy: the KKK, the human centipede, the coffin
- Resigned Oh boy: the beans bath, the Agile transformation, Sprint Zero month eleven
- Impressed/Awed Oh boy: something genuinely extraordinary even if terrible
- Very small Oh boy: when it's almost fine but not quite (the Bourbon is in his pocket)
- The Oh boy that is technically two words but takes four seconds to say:
  this is the bungee jump, the drowning, the being-shot-at
- The Oh boy that sounds like a question: the nudist colony, the sex therapy, the key bowl
- The Oh boy that is clearly inadequate to the situation but is all he has:
  the human centipede. Every time.

Al's response to every Oh boy: present. Ready. Slightly distracted.
The cigar moves. The handlink beeps. Ziggy has a probability.
